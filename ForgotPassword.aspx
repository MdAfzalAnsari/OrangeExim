<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ForgotPassword.aspx.cs" Inherits="Admin_ForgotPasswors" %>
...
<div id="templatemo_main">
    <%--<form id="Formforgot">--%>
                ...
                <table class="Adminprofile" style="width:auto;">                    
                        ...
                        <tr>
                            <td><NB:NBCaptcha ID="NBCaptcha1" runat="server" /></td>
                            <td><asp:TextBox ID="txtCaptchaText" runat="server" CssClass="txtInput" placeholder="Enter Captcha Here" ValidationGroup="forgotgroup"></asp:TextBox></td>
                            <td>
                                <asp:RequiredFieldValidator ValidationGroup="forgotgroup" ID="txtcaptchavalidate" runat="server" ErrorMessage="*" ControlToValidate="txtCaptchaText"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
